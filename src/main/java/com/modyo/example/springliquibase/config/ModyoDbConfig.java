package com.modyo.example.springliquibase.config;
...
@EnableJpaRepositories(
    basePackages = {"com.modyo.example.springliquibase.adapters.persistence"},
...
public class ModyoDbConfig {
  ...
  private static final String PERSISTENCE_ADAPTER_PACKAGE = "com.modyo.example.springliquibase.adapters.persistence";
