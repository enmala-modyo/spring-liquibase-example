package com.modyo.example.springdbschema.config;
...
@EnableJpaRepositories(
    basePackages = {"com.modyo.example.springdbschema.adapters.persistence"},
...
public class ModyoDbConfig {
  ...
  private static final String PERSISTENCE_ADAPTER_PACKAGE = "com.modyo.example.springdbschema.adapters.persistence";
